...
namespace SAE_DEV
{
    public class ScreenChargement : GameScreen
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                _positionVoiture = new Vector2(_largeurBarreChargement-LARGEUR_VOITURE, _myGame._graphics.PreferredBackBufferHeight - HAUTEUR_VOITURE + HAUTEUR_BARRE / 2 +4);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            _myGame.SpriteBatch.Draw(_textureVoitureChargement, _positionVoiture, null, Color.White, 0f,new Vector2(0, 0), 1f, SpriteEffects.None, 0);
